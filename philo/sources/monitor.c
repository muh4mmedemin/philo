...
static void check_eat_count_for_norm(pthread_mutex_t *philo_safe_lock, long long *b)
{
...
int opearate_philo_dead(t_global_data **data, unsigned long long kill_time, unsigned long long i)
{
